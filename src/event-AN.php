          ...
          <div class="field-name-body">
            ...
            <div class="field-group-format">
                ...
                <div class="field field-name-field-event-num-attendees">
                  ...
                  <div>
                    <span>36 persons are going</span>
                  </div>
...
<p>
 ...
 <div class="tags">Tags: <a class="tag" href="#">festivals</a></div>
    ...
    <a data-replace="modules/an-event-sidebar.php" <?php echo ($detect->isMobile() ? "data-media='(min-width: 900px)'" : ""); ?>><span class="element-invisible">
